...
# dblp
dblpdir=result/revision/dblp
mkdir -p ${dblpdir}
{ timeout 3h /usr/bin/time -v ./benchmark.out BEST -t 16 -w 0 -o ${dblpdir} -c 0.5 -e 1 -k 150 \
    -r data/dblp/small/query1000.txt -d data/dblp/small/authors.txt ; } 2> ${dblpdir}/time_report__best_t16_c0.5_150.txt
{ timeout 3h /usr/bin/time -v ./benchmark.out BEST -t 16 -w 0 -o ${dblpdir} -c 0.5 -e 1 \
    -r data/dblp/small/query1000.txt -d data/dblp/small/authors.txt ; } 2> ${dblpdir}/time_report__best_t16_c0.5_-1.txt

# { timeout 3h /usr/bin/time -v ./benchmark.out LPMS -t 16 -w 0 -o ${dblpdir} --relax DETERM -e 1 \
#     -r data/dblp/small/query1000.txt -d data/dblp/small/authors.txt ; } 2> ${dblpdir}/time_report_lpms_t16_determ_-1.txt
...
{ timeout 3h /usr/bin/time -v ./benchmark.out FREE -t 16 -w 0 -o ${dblpdir} -n 2 -c 0.2 -e 1 \
    -r data/dblp/small/query1000.txt -d data/dblp/small/authors.txt ; } 2> ${dblpdir}/time_report_free_t16_c0.2_n2_-1.txt
{ timeout 3h /usr/bin/time -v ./benchmark.out FREE -t 16 -w 0 -o ${dblpdir} -n 4 -c 0.15 -e 1 \
    -r data/dblp/small/query1000.txt -d data/dblp/small/authors.txt ; } 2> ${dblpdir}/time_report_free_t16_c0.15_n4_-1.txt
{ timeout 3h /usr/bin/time -v ./benchmark.out FREE -t 16 -w 0 -o ${dblpdir} -n 4 -c 0.1 -e 1 \
    -r data/dblp/small/query1000.txt -d data/dblp/small/authors.txt ; } 2> ${dblpdir}/time_report_free_t16_c0.1_n4_-1.txt


# webpage
webdir=result/revision/webpages
mkdir -p ${webdir}
{ timeout 3h /usr/bin/time -v ./benchmark.out BEST -t 16 -w 3 -o ${webdir} -c 0.1 -e 1 ; } 2> ${webdir}/time_report__best_t16_c0.1_-1.txt
...
mkdir -p ${proteindir}
{ timeout 3h /usr/bin/time -v ./benchmark.out BEST -t 16 -w 4 -o ${proteindir} -c 0.7 -e 1 -k 50; } 2> ${proteindir}/time_report__best_t16_c0.7_50.txt
{ timeout 3h /usr/bin/time -v ./benchmark.out BEST -t 16 -w 4 -o ${proteindir} -c 0.7 -e 1 -k 100; } 2> ${proteindir}/time_report__best_t16_c0.7_100.txt
...
mkdir -p ${trafficdir}
{ timeout 3h /usr/bin/time -v ./benchmark.out BEST -t 16 -w 4 -o ${trafficdir} -c 0.7 -e 1 ; } 2> ${trafficdir}/time_report__best_t16_c0.7_-1.txt
{ timeout 3h /usr/bin/time -v ./benchmark.out BEST -t 16 -w 4 -o ${trafficdir} -c 0.7 -e 1 -k 100; } 2> ${trafficdir}/time_report__best_t16_c0.7_100.txt
