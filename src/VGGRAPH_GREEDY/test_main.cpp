...
#include "Index/vggraph_greedy_index.hpp"
#include "../simple_query_matcher.hpp"

using namespace vggraph_greedy_index;
...
int main(int argc, char* argv[]) {
    ...
    // Create VGGraph_Greedy index
    VGGraph_Greedy index(dataset, queries, selectivity_threshold, upper_n, thread_count);
