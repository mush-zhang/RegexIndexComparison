/**
 * Implemented here: 
 *    https://github.com/DICL/FAST_FAIR/blob/master/concurrent/src/btree.h
 * In paper: 
...
// "C++17 removed the register keyword, 
//	so we define it to nothing so that it doesn't cause errors."
//  ---- Solution adapted from https://github.com/FastLED/FastLED/issues/1457
#if __cplusplus >= 201703L
#define register
#endif

#ifndef UTILS_BTREE_HPP_
#define UTILS_BTREE_HPP_
