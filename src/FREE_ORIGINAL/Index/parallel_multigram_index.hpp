#ifndef FREE_ORIGINAL_INDEX_PARALLEL_MULTIGRAM_INDEX_HPP_
#define FREE_ORIGINAL_INDEX_PARALLEL_MULTIGRAM_INDEX_HPP_
 ...
 public:
    ...
    ParallelMultigramIndex(const std::vector<std::string> & dataset, 
      ...
      : MultigramIndex(dataset, sel_threshold) {
            ...
            thread_count_ = std::min(ds_size, size_t(std::max(1, num_threads)));
...
#endif // FREE_ORIGINAL_INDEX_PARALLEL_MULTIGRAM_INDEX_HPP_