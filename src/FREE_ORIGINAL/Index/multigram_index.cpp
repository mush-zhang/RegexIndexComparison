...
void free_original_index::MultigramIndex::build_index(int upper_n) {
...
void free_original_index::MultigramIndex::fill_posting(int upper_n) {
...
void free_original_index::MultigramIndex::select_grams(int upper_n) {
...
void free_original_index::MultigramIndex::get_kgrams_not_indexed(
...
void free_original_index::MultigramIndex::get_uni_bigram(
        std::unordered_map<char, long double> & unigrams,
        std::unordered_map<std::pair<char, char>, long double, hash_pair> & bigrams) {
    for (const auto & line : k_dataset_) {
...
void free_original_index::MultigramIndex::insert_uni_bigram_into_index(
...
void free_original_index::MultigramIndex::insert_kgram_into_index(
